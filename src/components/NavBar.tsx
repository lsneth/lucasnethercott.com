...
export default function NavBar() {
  return (
    <nav className="sticky top-0 z-50 my-5 flex items-center justify-between rounded-full bg-black/40 px-6 py-4 backdrop-blur-md transition-all duration-300">
